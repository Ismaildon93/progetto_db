<?php
    ...
    /**
     * Questo file contiene gli script per la validazione dei luoghi preferiti inseriti dagli utenti 
     * per i cinguettii di tipo luogo
     * 
     */
...
<?php
     ...
     /* Questa sezione contiente gli script per la validazione dei luoghi preferiti*/
    ...
    //creo la query per l'inserimento del luogo preferito
    $sql = queryInsLuogoPreferito($input['utente_luogo'], $input['id_cinguettio']);
